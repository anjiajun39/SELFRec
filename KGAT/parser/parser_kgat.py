...
def parse_kgat_args():
    ...
    parser.add_argument('--data_name', nargs='?', default='ai_tec',
                        help='Choose a dataset from {yelp2018, last-fm, amazon-book, ai_tec}')
    ...
    parser.add_argument('--conv_dim_list', nargs='?', default='[64]', # [64, 32, 16]
    ...
    parser.add_argument('--Ks', nargs='?', default='[5, 10, 20, 40]',
